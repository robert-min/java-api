...
public class PDFFile {
    ...
    public void createPdf(String dest) throws MalformedURLException, IOException {
        ...
        try {
            headerFont = PdfFontFactory.createFont("NanumGothic-Regular.ttf", "Identity-H", true);
            bodyFont = PdfFontFactory.createFont("NanumGothic-Regular.ttf", "Identity-H", true);
        } catch (IOException e) {
            e.printStackTrace();
        }
        // Initialize table
